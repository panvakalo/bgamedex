      ...
      <div class="glass-surface p-6 text-center">
        ...
        <template v-else>
          ...
          <div class="flex gap-3 justify-center">
            <RouterLink
              to="/"
              class="px-6 py-2 bg-accent hover:bg-accent-light text-white font-medium border-2 border-accent"
            >
              Go to Bgamedex
            </RouterLink>
            <RouterLink
              to="/login"
              class="px-6 py-2 bg-surface-light border-2 border-surface-lighter text-text-secondary hover:text-text-primary"
            >
              Sign in
            </RouterLink>
          </div>
